...
class Filter extends View
{
     ...
     * @param string $field 字段
     * @param string $label 标签
     * @return \thinkEasy\form\field\DateTime|mixed
     */
     ...
     * @param string $label 标签
     * @return \thinkEasy\form\field\Cascader|mixed
     */
     ...
     * @return \thinkEasy\form\field\Radio|mixed
     */
     ...
     * 多选框
     * @param array $options 选项值
     * @return \thinkEasy\form\field\Checkbox|mixed
     */
     ...
     * 分组下拉框
     * @param array $options 选项值
     * @return \thinkEasy\form\field\Select|mixed
     */
